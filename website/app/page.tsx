        ...
        <div className="flex m-auto self-stretch flex-1 flex-wrap flex-col lg:flex-row sm:flex-row md:flex-row">
          <div className="flex-1 flex flex-wrap justify-items-start border-solid border-foreground border-y-4 border-2">
            <div className="m-2 flex flex-col place-content-center">
              ...
              <p className="m-2 text-pretty text-lg">We’re excited to kick off another season of SWMO Track Club, a competitive AAU Track and Field club dedicated to developing athletes of all skill levels. Whether you're sprinting towards personal bests, aiming for the podium, or just discovering your passion for the sport, this is the place for you!
                <br></br>
                <br></br>
              ...
              <a id="pm"></a>
              <p className="m-2 text-pretty text-lg font-bold"><br></br>2026 Parent Meeting!<br></br></p>
              <p className="m-2 text-pretty text-lg">Monday, March 23rd<br></br>5:30pm<br></br>Park in the WCHS pool parking lot
                ...
                <ol className="ml-5 text-lg list-decimal">
                    ...
                    <ul className="ml-5 text-lg list-disc">
                      ...
                      <ul className="ml-10 text-lg list-disc">
                        ...
                        <li>Choose 1 year extended coverage membership $24</li>
                        <li>Choose your club: SWMO Track Club - UB6UU5vB6</li>
                      </ul>
                    </ul>
                    ...
                    <ul className="ml-5 text-lg list-disc">
                      <li className="ml-5 text-lg list-disc">Join the SWMO Track Club 26</li>
                    ...
                    <ul className="ml-5 text-lg list-disc">
                      <li className="ml-5 text-lg list-disc"><a href="https://swmotrackclub.itemorder.com/shop/sale/" target="_blank" className="underline">Link (NOT READY YET)</a></li>
                    </ul>    
                </ol>
          </div>
        </div>
