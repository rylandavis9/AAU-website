...
export default function Home() {
  return (
    <main className="w-screen flex flex-col">
      ...
      <h1 className="w-full text-center text-6xl m-8 max-md:hidden font-extrabold " >SWMO Track Club</h1>
