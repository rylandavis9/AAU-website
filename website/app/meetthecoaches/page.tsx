      ...
      <main className="flex align-middle flex-col pt-24">
       <Navbar>
        ...
        <h1 className="m-2 text-pretty text-4xl self-center font-bold"><br></br>Meet The Coaches<br></br></h1>
          ...
          <p className="m-2 text-pretty text-lg font-bold"><br></br>Javelin Coach<br></br></p>
          <p className="m-2 text-pretty text-lg">Logan Bell attended Poplar Bluff High School where he graduated with 2 All-State Honors in the Javelin. He also was a part of Missouri Southern State's track and field team from 2018-2023. He received All-American Honors in 2021 in the javelin throw. He is in his third year of coaching, 1st year at Webb City High School and has had 1 All-State athlete in the javelin in his coaching career. He teaches 7th grade Career Explorations at Webb City Junior High.<br></br></p>
