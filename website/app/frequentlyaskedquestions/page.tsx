        ...
        <div className="" >
          <h1 className="w-full text-center text-4xl font-extrabold " >FAQ</h1>
              ...
              <h2 className="mx-2 text-xl font-extrabold " ><br></br>2. What is the required commitment?</h2>
                <ul className="ml-8 mr-2 text-lg list-disc">
                    <li className="ml-8 mr-2 text-lg list-disc">The commitment you have to the team is completely up to you as a family.</li>
                    <li className="ml-8 mr-2 text-lg list-disc">No one is required to be at practice and no one is required to attend meets. While meets are good for the athletes, we totally understand that some families have other commitments.  </li>
                    <ul className="ml-8 mr-2 text-lg list-disc">
                      <li className="ml-8 mr-2 text-lg list-disc">Requirements</li>
              ...
              <h2 className="mx-2 text-xl font-extrabold " ><br></br>4. What events can my athlete compete in?</h2>
                <ul className="ml-8 mr-2 text-lg list-disc">
                    <li className="ml-8 mr-2 text-lg list-disc">AAU offers a variety of events per age group (listed on the AAU rules tab)</li>
                    <li className="ml-8 mr-2 text-lg list-disc">SWMO Track Club will only coach the events that we can safely cover. This will depend on how many parent volunteer coaches sign up.  </li>
                </ul>
