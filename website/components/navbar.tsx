...
interface Props {
  ...
  const Navbar = ({children, ...props}: Props) => {
    return (
      <main>
        <div className="hidden sticky top-0 max-md:grid grid-cols-3 grow shrink bg-[#1d252b] border-solid border-[#1d252b] border-y-4 text-[#51cb20] items-center space box-content w-full h-1/5 min-h-14 max-h-20">
          <div className="self-center justify-center align-middle">
            <h1 className="font-bold m-2"></h1>
          </div>
          <div className="">
            <h1 className="font-bold m-2">SWMO&nbsp;Track&nbsp;Club</h1>
          </div>
          ...
          <div className=" sticky top-0 flex grid-cols-9 grow shrink bg-[#1d252b] border-solid border-[#1d252b] border-y-4 text-[#51cb20] items-center place-content-center box-content w-full h-1/5 min-h-14 max-h-20">
            ...
            <div className="grow shrink">
              <DropdownMenu>
                ...
                <DropdownMenuContent className="bg-[#1d252b]">
